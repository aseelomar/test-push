        ...
        <div class="d-flex align-items-center">
            <div class="mr-auto">
                ...
                <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                    ...
                    <li class="m-nav__item">
                        <a href="" class="m-nav__link">
                            <span class="m-nav__link-text"> اضافة عضو مجلس بلدي</span>
                        </a>
                    </li>
            ...
            <div>
                <div class=" order-j1 order-xl-2 m--align-right">
                    ...
                    <button type="submit" class="btn m-btn--pill btn-success save" id="add-municipal-member">
                            <span>
...
@section('content')
    ...
    <div class="m-portlet m-portlet--bordered m-portlet--unair">
        <form class="m-portlet__body" action="{{route('admin.municipalMember.store')}}" id="add-new-municipal-member" method="POST" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="m-portlet m-portlet--bordered m-portlet--unair">
                        ...
                        <div class="m-portlet__body">
                            ...
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-10">
                                    <input class="form-control m-input " placeholder="ادخل التخصص الجامعي" type="text" value="{{ old('certification') }}" name="certification" id="example-text-input">
                            ...
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-10">
                                    <input class="form-control m-input " placeholder="ادخل لينك فيسبوك" type="text" value="{{ old('facebook') }}"  name="facebook" id="example-text-input">
                                </div>
                            </div>
                            <hr>
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-10">
                                    <input class="form-control m-input " placeholder="ادخل لينك تويتر" type="text" value="{{ old('twitter') }}" name="twitter" id="example-text-input">
                                </div>
                            </div>
                            <hr>
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-10">
                                    <input class="form-control m-input " placeholder="ادخل لينك انستجرام" type="text" value="{{ old('instagram') }}" name="instagram" id="example-text-input">
                                </div>
                            </div>
                            <hr>
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-10">
                                    <input class="form-control m-input " placeholder="ادخل لينك لينكدإن" type="text" value="{{ old('linkedIn') }}" name="linkedin" id="example-text-input">
                                </div>
                            </div>
                            <hr>
                            <div class="form-group m-form__group row">
                                <label for="example-text-input" class="col-2 col-form-label  ">ارفع صورة شخصية</label>
                                    ...
                                    <div class="icon text-center">
                                        ...
                                        <img width="100%" height="150" src="" alt="" class="img">
                                    </div>
