        ...
        <div class="d-flex align-items-center">
            <div class="mr-auto">
                ...
                <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                    ...
                    <li class="m-nav__item">
                        <a href="" class="m-nav__link">
                            <span class="m-nav__link-text">تعديل وظيفة </span>
                        </a>
                    </li>
            ...
            <div>
                <div class=" order-j1 order-xl-2 m--align-right">
                    ...
                    <button type="submit" class="btn m-btn--pill btn-success save" id="update-job">
                            <span>
...
@section('content')
    ...
    <div class="m-portlet m-portlet--bordered m-portlet--unair">
        <form class="m-portlet__body" action="{{route('admin.job.update',$job->id)}}" id="update-jobs" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-lg-9">
                    <!--begin::Portlet-->
                    <div class="m-portlet m-portlet--bordered m-portlet--unair">
                        <div class="m-portlet__head">
                            <div class="m-portlet__head-caption">
                                <div class="m-portlet__head-title">
                                    ...
                                    <h3 class="m-portlet__head-text">تعديل بيانات الوظيفة</h3>
                        ...
                        <div class="m-portlet__body">
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-10">
                                    <input class="form-control m-input " placeholder="{{ 'ادخل عنوان الوظيفة' }}" type="text" value="{{ $job->title }}" name="title" id="example-text-input">
                                </div>
                            </div>
                            <div class="form-group m-form__group row">
                                <label for="example-text-input"  class="col-2 col-form-label  ">{{ 'ادخل رابط الوظيفة' }}</label>
                                <div class="col-10">
                                    <input class="form-control m-input " placeholder="{{ 'ادخل رابط الوظيفة' }}" type="text" value="{{$job->link }}" name="link" id="example-text-input">
                                </div>
                            </div>
                            ...
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-10">
                                    <textarea name="description" style="height: 400px" class="summernote" id="m_summernote_1">{{$job->description}}</textarea>
                ...
                <div class="col-lg-3">
                    ...
                    <div class="m-portlet m-portlet--bordered m-portlet--bordered-semi m-portlet--rounded">
                        ...
                        <div class="custom-file-upload">
                            ...
                            <input name="image" value="{{$job->image}}" accept="image/*" type="file" id="news-img">
                        </div>
