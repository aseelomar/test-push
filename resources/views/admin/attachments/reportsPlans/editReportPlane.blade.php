                    ...
                    <div class="m-portlet m-portlet--bordered m-portlet--unair">
                            ...
                            <div class="m-portlet__head-caption">
                                <div class="m-portlet__head-title">
                                    <h3 class="m-portlet__head-text">
                                        تعديل <span>  {{ $attachment->category->name }}</span>
                                    </h3>
                        ...
                        <div class="m-portlet__body">
                            ...
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-10">
                                    <input class="form-control m-input " placeholder="ادخل اسم الخطة" type="text" value="{{$attachment->description }}" name="description" id="example-text-input">
                                </div>
                            </div>
                            <hr>
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-10">
                                    ...
                                    <div class="custom-file">
                                        <input type="file" name="link" value="{{$attachment->link}}" class="custom-file-input" id="customFileLang" >
                                        <label class="custom-file-label" for="customFileLang">{{$attachment->link}}</label>
                                    </div>
                                </div>
                            </div>
                        </div>
