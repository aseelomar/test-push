        ...
        <div class="d-flex align-items-center">
            <div class="mr-auto">
                ...
                <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                    ...
                    <li class="m-nav__item">
                        <a href="" class="m-nav__link">
                            <span class="m-nav__link-text"> اضافة خدمة جديدة</span>
                        </a>
                    </li>
            ...
            <div>
                <div class=" order-j1 order-xl-2 m--align-right">
                    ...
                    <button type="submit" class="btn m-btn--pill btn-success save" id="add-service">
                            <span>
...
@section('content')
    ...
    <div class="m-portlet m-portlet--bordered m-portlet--unair">
        <form class="m-portlet__body" action="{{route('admin.services.store')}}" id="add-new-service" method="POST" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="m-portlet m-portlet--bordered m-portlet--unair">
                        ...
                        <div class="m-portlet__body">
                            ...
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-10">
                                    <input class="form-control m-input " placeholder="ادخل اسم الخدمة" type="text" value="{{ old('name') }}" name="name" id="example-text-input">
                                </div>
                            </div>
                            <hr>
                            <div class="form-group m-form__group row">
