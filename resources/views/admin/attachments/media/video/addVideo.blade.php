                    ...
                    <div class="m-portlet m-portlet--bordered m-portlet--unair">
                        ...
                        <div class="m-portlet__body">
                            ...
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-10">
                                    <input class="form-control m-input " placeholder="ادخل رابط الفيديو" type="text" value="{{ old('link') }}" name="link" id="example-text-input">
                                </div>
                            </div>
                        </div>
                        <div class="form-group m-form__group row">
                            <label for="example-text-input"  class="col-2 col-form-label  ">ارفع الصورة للفيديو</label>
