...
@section('content')
    ...
    <div class="m-portlet m-portlet--mobile">
        <div class="m-portlet__body">
            ...
            <div class="m-form m-form--label-align-right m--margin-top-20 m--margin-bottom-30">
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-4 order-1 order-xl-2 m--align-right">
                        <a href="{{ route('admin.publications.add',$category->id)}}" class="btn btn-primary m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
												<span>
													<i class="far fa-newspaper"></i>
													<span>{{ 'اضافة منشور جديد' }}</span>
												</span>
                        </a>
            ...
            <table class="table table-striped table-bordered table-hover table-checkable" id="publication_table">
                <input type="text" hidden value="{{$category->id}}" id="category_id">
                <thead>
                <tr>
