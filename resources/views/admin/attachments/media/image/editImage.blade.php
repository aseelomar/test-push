                            ...
                            <div class="form-group m-form__group row">
                                ...
                                <div class="custom-file-upload col-4">
                                    <div class="icon text-center">
                                        ...
                                        <img width="100%" height="248" src="{{ asset('storage/attachment/media/' . $attachment->link) }}" alt="" class="img">
                                    </div>
                                    <input name="image" value="{{$attachment->link}}" accept="image/*" type="file" id="news-img">
                                </div>
                            </div>
