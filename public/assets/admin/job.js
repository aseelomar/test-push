...
var Job = function () {
    ...
    var viewTable = function () {
        ...
        view_tbl = DataTable.init($('#job_table'), link, columns, order, ajaxFilter, perPage);
    };
    /////////////////// ADD ///////////////////
    ///////////////////////////////////////////
    ...
    var add = function () {
        $('#add-job').on('click', function (e) {
            let form = document.getElementById('add-new-job');
    ...
    var updateJob=function () {
        $('#update-job').on('click', function (e) {
            e.preventDefault();
            let form = document.getElementById('update-jobs');
            var formData = new FormData(form);
            let method = form.getAttribute('method');
            let link = form.getAttribute('action');
            Forms.doAction(link, formData, method, null, addCallBack);
